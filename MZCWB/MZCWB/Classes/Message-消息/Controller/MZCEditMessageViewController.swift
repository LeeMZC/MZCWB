...
class MZCEditMessageViewController: UIViewController {
    ...
    //MARK:- 工厂
//    class func messageTableViewController() -> MZCEditMessageViewController {
//        return NSBundle.mainBundle().loadNibNamed("MZCMessageTableViewController", owner: nil, options: nil).last as! MZCMessageTableViewController
//    }
